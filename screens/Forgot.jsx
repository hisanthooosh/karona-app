...
const Place = require("../Asets/Images/good.png");
    ...
    return (
        ...
        <View style={styles.bodylogin}>
            ...
            <View style={styles.part2}>
                ...
                <Text style={styles.part2title}>Recover password with <Text style={styles.part2colortitle}>Karona</Text></Text>
            ...
            <View style={styles.part3} >
                ...
                <SafeAreaView style={styles.form}>
                    ...
                    <TextInput keyboardType="text" style={styles.part3input} placeholder="Enter password" />

                    <TextInput keyboardType="text" style={styles.part3input} placeholder="Reenter password" />
